...
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 4, '스토리가 복잡하지만 볼수록 매력있어요.', 1, 'user2', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 5, '놀란 감독의 최고작이라고 생각합니다.', 1, 'user3', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 5, '칸 황금종려상 수상작. 완벽한 영화입니다.', 2, 'user1', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 4, '결말이 충격적이었어요. 강추!', 2, 'user3', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 5, '마동석 형님 믿고 보는 영화.', 3, 'user2', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 4, '통쾌하고 재미있어요.', 3, 'user1', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 5, '눈물 펑펑 흘렸습니다. 명작이에요.', 4, 'user2', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 5, 'OST도 너무 좋아요. 반복 감상 중입니다.', 4, 'user3', SYSDATE, SYSDATE);
INSERT INTO tbl_reviews (rno, score, content, movie_id, writer, reg_date, modify_date) VALUES (review_seq.NEXTVAL, 4, '따뜻하고 감동적인 영화입니다.', 5, 'user1', SYSDATE, SYSDATE);
