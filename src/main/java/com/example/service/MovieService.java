...
public class MovieService {
	...
	public List<Movie> getList(String cat, String searchText, Pageable pageable) {
		if (searchText == null)
	...
	public Map<Long, Double> getAvgScores(List<Movie> list) {
		List<Long> mnoList = list.stream().map(Movie::getMno).collect(Collectors.toList());
	...
	// 영화 단건 조회
	public Movie findById(Long mno) {
