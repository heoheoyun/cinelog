...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                .requestMatchers(
                        "/", "/member/login", "/member/reg",
                        "/movie/list", "/movie/detail",
                        "/css/**", "/js/**", "/uploads/**"
                ).permitAll()
                .requestMatchers("/movie/reg", "/movie/modify", "/movie/delete").hasRole("ADMIN")
                .requestMatchers("/member/mypage", "/member/edit/**", "/review/**").authenticated()
